...
object BlockTankGasInput extends BaseModule("tank_gas_input", "FluidInput", classOf[TileTankGasInput])

class TileTankGasInput extends TileModule with CapabilityProvider with GasHandlerProxy {
